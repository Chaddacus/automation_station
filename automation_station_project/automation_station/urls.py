...
urlpatterns = [
    ...
    path('zp_create_site_v1', views.create_site_v1, name='zp_create_site_v1'),
    path('zp_create_common_area_v1', views.create_common_area_v1, name='zp_create_common_area_v1'),
    path('zp_create_auto_receptionist_v1', views.create_auto_receptionist_v1, name='zp_create_auto_receptionist_v1'),
    path('zp_create_call_queue_v1', views.create_call_queue_v1, name='zp_create_call_queue_v1'),
