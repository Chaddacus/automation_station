...
from .models import ZoomPhoneQueue, Job, JobCollection, JobExecutionLogs, ZoomPhoneQueueMembers, ZoomPhoneAddSites, ZoomPhoneAddAutoReceptionist, ZoomPhoneUpdateAutoReceptionist, ZoomPhoneAddCommonAreas, ZoomCCQueue, ZoomCCUpdateQueue, ZoomCCDisposition, ZoomCCAddUsers
...
from automation_station_project.tasks import create_call_queue, add_call_queue_members, add_sites, add_auto_receptionist, update_auto_receptionist, add_common_areas, cc_create_call_queue, cc_update_call_queue, cc_create_disposition, cc_add_users
